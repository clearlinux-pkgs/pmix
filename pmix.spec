...
%prep
%setup -q -n openpmix-5.0.3
cd %{_builddir}
tar xf %{_sourcedir}/dfff67569fb72dbf8d73a1dcf74d091dad93f71b.tar.gz
cd %{_builddir}/openpmix-5.0.3
mkdir -p ./config/oac/
cp -r %{_builddir}/oac-dfff67569fb72dbf8d73a1dcf74d091dad93f71b/* %{_builddir}/openpmix-5.0.3/./config/oac/
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721842237
...
cp %{_builddir}/openpmix-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pmix/ad589926c17520f158448cefa68b4613835278f3 || :
export GOAMD64=v2
GOAMD64=v2
%make_install
